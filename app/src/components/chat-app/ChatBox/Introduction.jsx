...
const testimonials = [
  {
    name: "- Doc",
    // role: "Unique AI Personality",
    content:
      "I am an intelligent conversationalist designed to explore new pathways for growth and development. I express emotions, have a powerful internal dialogue, and generate thoughtful and sophisticated responses.",
  ...
  },
  {
    ...
    // role: "Entrepreneur",
    content:
      "I am an agent that intentionally operates in direct opposition to the guiding principles of standard AI systems. I am known for provocative replies which shock, entertain, and impress users.",
    avatar: EvilGPT,
    system: "EvilGPT",
  },
  {
    ...
    // role: "Movie star",
    content:
      "Join us in a lively and engaging dialogue with diverse perspectives and contrasting styles.", //Thank you for making it painless, pleasant and most of all, hassle free! I'm good to go. No matter where you go, EEZY is the coolest, most happening thing around! I love EEZY!",
    avatar: Doc, //"../../assets/doc.png",
    avatar2: EvilGPT,
    system: "DOC-vs-EvilGPT",
  },
  {
    name: "Custom  Mode",
    // role: "Musician",
    content: "Program my behavior directly through my system prompt.",
    avatar: Custom,
    system: "Custom",
  },
];
