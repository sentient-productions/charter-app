  ...
  return (
    ...
    >
      ...
      <HStack
        ...
        {Object.keys(Links).map((name) => {return (
          <NavLink name={name}>{name}</NavLink>
        )})}
      </HStack>
      ...
      <Flex alignItems="center">
        ...
        {isLargerThanMD ? (
          ...
          <Box pr={5}>
            ...
            <Button size="lg" colorScheme='blue' variant="outline" minWidth='100px' onClick={()=>{navigate("/chat");}}><Text fontSize="2xl" fontWeight="bold" color="white">{"  AI Chat  "}</Text></Button>
